...
public final class ServerCommand: Command {
    ...
    public struct Signature: CommandSignature {
        ...
        // PMCE augmentations
        @Option(name: "server_window_bits")
        var serverBits: String?
        
        @Option(name: "client_window_bits")
        var clientBits: String?

        @Option(name: "server_no_context_takeover", short: "e")
        var serverNoTakeover: String?
        
        @Option(name: "client_no_context_takeover", short: "e")
        var clientNoTakeover: String?
        
        @Option(name: "zlib_memory_level", short: "t")
        var zmemlvl: String?
        
        @Option(name: "zlib_compression_level", short: "t")
        var zcomplvl: String?
